...
// Asset imports
import { ConfidoCover, ConfidoWebsite } from '../../../assets'
  ...
  return (
    <>
      <section
        ...
        style={{ backgroundImage: 'url(' + ConfidoCover + ')' }}
      >
        <div className="container mx-auto px-4">
          ...
          <div className="text-lg md:flex gap-12">
            <div className="mb-4 md:mb-0">
              ...
              Mobile Development, Mobile Design, Branding
            </div>
            <div>
              ...
              {/* <a
                target="_blank"
                href="https://www.confido-app.com"
      ...
      <section className="border-black border-t-2 py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg max-w-xl mb-16">
            Confido is a native mobile app for iOS and Android. Meerkat
            Development takes care of the development process as well as the
            overall branding and design for Confido. <br />
            <br />
          ...
          <ul className="text-lg flex flex-wrap gap-8">
            ...
            <li className="flex flex-col text-center bg-white border-black border-2 rounded-lg p-2">
              <span className="font-bold text-xl">Google Firestore</span>
            </li>
          </ul>
        </div>
      </section>
